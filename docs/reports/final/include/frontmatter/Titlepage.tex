...
{\Large QUFEI WANG} \setlength{\parskip}{2.9cm}
...
\oneLineTitle\\
% \oneLineSubtitle\\
QUFEI WANG \setlength{\parskip}{1cm}

\copyright ~ QUFEI WANG, \the\year. \setlength{\parskip}{1cm}

Supervisor: Thierry Coquand, Department of Computer Science and Engineering\\
Examiner: Ana Bove, Department of Computer Science and Engineering \setlength{\parskip}{1cm}
